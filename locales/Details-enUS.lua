...
-- OPTIONS PANEL -----------------------------------------------------------------------------------------------------------------
	...
	Loc ["STRING_OPTIONS_OVERALL_RAIDBOSS_DESC"] = "Raid encounters are added to overall data."
	Loc ["STRING_OPTIONS_OVERALL_RAIDCLEAN"] = "Raid Cleanups"
	Loc ["STRING_OPTIONS_OVERALL_RAIDCLEAN_DESC"] = "Raid cleanups are added to overall data."
	Loc ["STRING_OPTIONS_OVERALL_DUNGEONBOSS"] = "Dungeon Bosses"
	Loc ["STRING_OPTIONS_OVERALL_DUNGEONBOSS_DESC"] = "Dungeon encounters are added to overall data."
	Loc ["STRING_OPTIONS_OVERALL_DUNGEONCLEAN"] = "Dungeon Cleanups"
	Loc ["STRING_OPTIONS_OVERALL_DUNGEONCLEAN_DESC"] = "Dungeon cleanups are added to overall data."
	Loc ["STRING_OPTIONS_OVERALL_ALL"] = "Everything"
