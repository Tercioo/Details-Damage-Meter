...
--> Custom Window
	...
	Loc ["STRING_CUSTOM_ATTRIBUTE"] = "Attribute:"
	
	Loc ["STRING_CUSTOM_ATT1"] = "Damage"
	Loc ["STRING_CUSTOM_ATT2"] = "Heal"
	Loc ["STRING_CUSTOM_ATT3"] = "Energy"
	Loc ["STRING_CUSTOM_ATT4"] = "Misc"
...
-- OPTIONS PANEL -----------------------------------------------------------------------------------------------------------------
	...
	Loc ["STRING_OPTIONS_AUTO_SWITCH_DESC"] = "When you enter in combat, this window changes for the selected attribute or plugin.\n\nLeaving the combat, it switch back."
	
	Loc ["STRING_OPTIONS_AUTO_SWITCH_WIPE"] = "After Encounter Wipe"
	Loc ["STRING_OPTIONS_AUTO_SWITCH_WIPE_DESC"] = "After a fail attempt in defeat a raid encounter, this window automatically show this."
	
	Loc ["STRING_OPTIONS_AUTO_SWITCH_DAMAGER"] = "As Damager"
	Loc ["STRING_OPTIONS_AUTO_SWITCH_DAMAGER2"] = "As Damager (in combat)"
	Loc ["STRING_OPTIONS_AUTO_SWITCH_DAMAGER_DESC"] = "Auto switch what is show in this window when you are in a damager specialization."
	
	Loc ["STRING_OPTIONS_AUTO_SWITCH_HEALER"] = "As Healer"
	Loc ["STRING_OPTIONS_AUTO_SWITCH_HEALER2"] = "As Healer (in combat)"
	Loc ["STRING_OPTIONS_AUTO_SWITCH_HEALER_DESC"] = "Auto switch what is show in this window when you are in a healer specialization."
	
	Loc ["STRING_OPTIONS_AUTO_SWITCH_TANK"] = "As Tank"
	Loc ["STRING_OPTIONS_AUTO_SWITCH_TANK2"] = "As Tank (in combat)"
	Loc ["STRING_OPTIONS_AUTO_SWITCH_TANK_DESC"] = "Auto switch what is show in this window when you are in a tank specialization."
