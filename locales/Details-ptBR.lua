...
--> Custom Window -- traduzir
	...
	Loc ["STRING_CUSTOM_POT_DEFAULT"] = "Pocao Usada"
	Loc ["STRING_CUSTOM_HEALTHSTONE_DEFAULT"] = "Pedra de Vida Usada"	
