...
--> global name declaration
		...
		_detalhes.build_counter = 38 --it's 45 for release
		_detalhes.userversion = "v1.23.5"
...
do 
	...
	--[[
|cFFFFFF00a1.23.0 (|cFFFFCC00Ago 23, 2014|r|cFFFFFF00)|r:\n\n
