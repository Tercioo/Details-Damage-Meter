...
--> global name declaration
		...
		_detalhes.build_counter = 656 --it's 656 for release
		_detalhes.userversion = "v3.11.2"
		_detalhes.realversion = 64 --core version
