...
--> global name declaration
		...
		_detalhes.build_counter = 220 --it's 220 for release
		_detalhes.userversion = "v3.2.4a"
		_detalhes.realversion = 47 --core version
