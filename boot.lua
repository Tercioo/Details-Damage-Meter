...
--> global name declaration
		...
		_detalhes.build_counter = 2480 --it's 2480 for release
		_detalhes.userversion = "v4.3.2"
		_detalhes.realversion = 80 --core version
