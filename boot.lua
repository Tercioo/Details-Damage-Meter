...
--> global name declaration
		...
		_detalhes.build_counter = 70 --it's 73 for release
		_detalhes.userversion = "v1.26.0"
...
do 
	...
	--[[
|cFFFFFF00v1.26.0 (|cFFFFCC00Set 10, 2014|r|cFFFFFF00)|r:\n\n
