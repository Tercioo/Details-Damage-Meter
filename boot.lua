...
--> global name declaration
		...
		_detalhes.build_counter = 7219
		_detalhes.alpha_build_counter = 7219 --if this is higher than the regular counter, use it instead
...
--[[
|cFFFFFF00v8.2.5.7219.140 (|cFFFFCC00October 16th, 2019|r|cFFFFFF00)|r:\n\n
