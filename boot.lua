...
--> global name declaration
		...
		_detalhes.build_counter = 252 --it's 252 for release
		_detalhes.userversion = "v3.4.3"
		_detalhes.realversion = 49 --core version
