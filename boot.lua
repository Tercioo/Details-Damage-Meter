...
--> global name declaration
		...
		_detalhes.build_counter = 1382 --it's 1382 for release
		_detalhes.userversion = "v3.17.12"
...
--[[
|cFFFFFF00v3.17.11 (|cFFFFCC00Aug 04, 2015|r|cFFFFFF00)|r:\n\n
|cFFFFFF00-|r Fixed an issue with bookmarks not opening correctly.\n\n
