...
--> global name declaration
		...
		_detalhes.build_counter = 125 --it's 129 for release
		_detalhes.userversion = "a2.1.0"
		_detalhes.realversion = 33
