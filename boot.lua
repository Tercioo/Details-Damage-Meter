...
--> global name declaration
		...
		_detalhes.build_counter = 160 --it's 183 for release
		_detalhes.userversion = "a3.1.1"
		_detalhes.realversion = 45
		_detalhes.version = _detalhes.userversion .. " (core " .. _detalhes.realversion .. ")"

-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--> initialization stuff

-- remover print do power types differente.
