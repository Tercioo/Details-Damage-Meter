...
--> global name declaration
		...
		_detalhes.build_counter = 711 --it's 711 for release
		_detalhes.userversion = "v3.11.5"
		_detalhes.realversion = 65 --core version
