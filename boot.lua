...
--> global name declaration
		...
		_detalhes.build_counter = 212 --it's 212 for release
		_detalhes.userversion = "v3.2.0"
		_detalhes.realversion = 46
