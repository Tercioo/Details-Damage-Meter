...
--> global name declaration
		...
		_detalhes.build_counter = 125 --it's 135 for release
		_detalhes.userversion = "a2.1.2"
		_detalhes.realversion = 34
