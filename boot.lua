...
--> global name declaration
		...
		_detalhes.build_counter = 1150 --it's 1150 for release
		_detalhes.userversion = "v3.15.8a"
		_detalhes.realversion = 70 --core version
