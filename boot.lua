...
--> global name declaration
		...
		_detalhes.build_counter = 148 --it's 149 for release
		_detalhes.userversion = "a2.2.0"
		_detalhes.realversion = 35
