...
--> global name declaration
		...
		_detalhes.build_counter = 38 --it's 41 for release
		_detalhes.userversion = "v1.23.0"
...
--> functions
	...
	--> register textures and fonts for shared media
		...
		--SharedMedia:Register ("font", "UT Saah", [[Interface\Addons\Details\fonts\utsaahb.ttf]])
