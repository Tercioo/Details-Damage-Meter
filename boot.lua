...
--> global name declaration
		...
		_detalhes.build_counter = 389 --it's 389 for release
		_detalhes.userversion = "v3.7.1"
		_detalhes.realversion = 57 --core version
...
|cFFFFFF00-|r Fixed wallpaper transparency after releasing the window from a stretch.
