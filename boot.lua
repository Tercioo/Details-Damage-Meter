...
--> global name declaration
		...
		_detalhes.build_counter = 286 --it's 286 for release
		_detalhes.userversion = "v3.6.2"
		_detalhes.realversion = 51 --core version
