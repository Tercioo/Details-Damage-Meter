...
--> global name declaration
		...
		_detalhes.build_counter = 160 --it's 179 for release
		_detalhes.userversion = "a3.0.2"
		_detalhes.realversion = 40
