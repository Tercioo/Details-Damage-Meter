...
--> global name declaration
		...
		_detalhes.build_counter = 996 --it's 996 for release
		_detalhes.userversion = "v3.15.1a"
		_detalhes.realversion = 69 --core version
