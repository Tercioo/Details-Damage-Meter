...
--> global name declaration
		...
		_detalhes.build_counter = 157 --it's 167 for release
		_detalhes.userversion = "a3.0.0"
		_detalhes.realversion = 37
