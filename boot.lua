...
--> global name declaration
		...
		_detalhes.build_counter = 2196 --it's 2196 for release
		_detalhes.userversion = "v4.1.5"
		_detalhes.realversion = 78 --core version
