...
--> global name declaration
		...
		_detalhes.build_counter = 311 --it's 311 for release
		_detalhes.userversion = "v3.6.8"
		_detalhes.realversion = 53 --core version
