...
["maxAmount"] = 7903,
    ...
    for i = 1, amountOfSpellsToShow do
        ...
        --
        --_print(issecretvalue(creatureName), "creatureName", creatureName)
        ...
        if not success then
            ...
            local data = {
                ...
                texts = {AbbreviateNumbers(spellAmount, abbreviateSettingsDamage), AbbreviateNumbers(dps, abbreviateSettingsDPS)},
                amount = spellAmount,
            }
            tooltipData[#tooltipData + 1] = data
            ...
            local data = {
                name = leftText,
                icon = spellInfo.iconID,
                texts = {AbbreviateNumbers(spellAmount, abbreviateSettingsDamage), AbbreviateNumbers(dps, abbreviateSettingsDPS), format("%.1f%%", percent)},
                amount = spellAmount,
            }
