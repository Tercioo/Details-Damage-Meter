...
--reset button functions
	local resetButton_OnEnter = function(self, _, bForceOpen)
		...
		gameCooltip:AddLine(Loc["STRING_ERASE_COMMON_SEGMENTS"], nil, 1, "white", nil, Details.font_sizes.menus, Details.font_faces.menus)
		...
		gameCooltip:AddLine(Loc["STRING_ERASE_KEEP_MYTHIC_SEGMENT"], nil, 1, "white", nil, Details.font_sizes.menus, Details.font_faces.menus)
		gameCooltip:AddIcon([[Interface\Buttons\UI-StopButton]], 1, 1, 14, 14, 0, 1, 0, 1, "orange")
